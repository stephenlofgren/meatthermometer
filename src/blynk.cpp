...
void blynkLoop(int temperature){
    ...
    if(Blynk.connected()){
      ...
      String msg = "Temperature Reading: " + String(temperature) + " on pin:" + String(_sensorSettings.valuePin);
      Blynk.virtualWrite(_sensorSettings.valuePin, temperature);
      println(msg);
    }    
}
